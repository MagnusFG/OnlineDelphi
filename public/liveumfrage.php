<?php
/**
 * LIVEUMFRAGE - Part of OnlineDelphi project. This source file contains the hmtl 
 * structur of the Live Umfrage and shows questions, answers and 
...
<html lang="en">
    ...
    <body>
        ...
        <!-- umfrage laden -->
        <section class="content content-live">
            <?php
            $umfrageTyp = 2;

// Benutzer ID
            if (isset($_SESSION['loginUserID'])) { // angemeldeter user?
